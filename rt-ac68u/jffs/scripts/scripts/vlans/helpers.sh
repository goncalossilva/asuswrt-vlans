...
# CPU port (i.e., port to Linux kernel) is port 5

configure_vlans_on_switch_ports() {
    robocfg vlans reset
    robocfg vlan 1 ports "0 1t 2t 3t 4t 5t"
    robocfg vlan 10 ports "0t 1t 3 4 5t" # Ports 3 and 4 connect to Proxmox and Portainer
    robocfg vlan 20 ports "0t 1t 2 5t" # Switch under TV on port 2
    robocfg vlan 30 ports "0t 1t 5t" # Rest of network is on port 1
}
